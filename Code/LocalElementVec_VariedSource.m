...
LocalVec_Source = [(f*J*(1+(8/3)*x0+(4/3)*x1)) (f*J*(1+(8/3)*x0+(4/3)*x1))]; % Form the local source vector. The derrivation of this can be found in the corsework report part 1c.
