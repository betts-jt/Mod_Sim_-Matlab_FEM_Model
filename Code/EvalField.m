function [ val ] = EvalField(msh,field,eID,xi)
...
psi = [EvalBasis(0,xi) EvalBasis(1,xi)]; % Get vector containing basis function values at xipt

dpsidxi = [EvalBasis(0,xi) EvalBasis(1,xi)]; % Get vector containing basis function gradients at xipt
